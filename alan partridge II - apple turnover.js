...
// If I squeeze it, a jet of molten Bramley apple is going to squirt out. Could go your way, could go mine.
...
console.log(howHot("20"));
console.log(howHot("5600"));
console.log(howHot(630));
console.log(howHot(30));
