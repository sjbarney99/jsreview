...
//The notes come together like you wouldn't believe as the musician puts together patterns of tunes.
...
//"Its always gonna be about tree fiddy."
//
...
const findNessie = (s, word) => {
	let finder = new RegExp("\\b" + word + "\\b", "i").test(s);
	return finder;
};

console.log(findNessie("I have been playing since tree fiddy", "tree fiddy"));
console.log(findNessie("I wonder where Nessie is.", "tree fiddy"));
